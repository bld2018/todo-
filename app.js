...
async function matchTeams() {
    ...
    const TARGET = 2026;
    const combos = findAllPerfectCombinations(participants, TARGET);
...
function renderMatchResult(combos) {
    ...
    let html = `
        <div style="text-align: center; margin-bottom: 25px;">
            ...
            <div style="color: #8c8c8c;">总分恰好等于2026分</div>
        </div>
    `;
        ...
        html += `
            <div class="combo-card">
                <div class="combo-header">
                    ...
                    <div class="combo-total">2026 分</div>
                </div>
